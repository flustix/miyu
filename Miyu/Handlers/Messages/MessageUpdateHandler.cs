...
internal class MessageUpdateHandler : SocketEventHandler
{
    public MessageUpdateHandler(MiyuClient client, GatewayEventHandler handler)
        : base(client, handler)
    {
    }
    ...
    internal override void Handle(JObject data)
    {
        ...
        Handler.DispatchEvent(new MessageUpdateEvent(Client, message, channel, guild, member));
    }
}
